...
class Product extends My_Controller
{
    ...
    $books=$this->pdModel->getAllDataPhoneByKeyword($keyword);
    ...
    // print_r($panigate);
    // die();
    $data['product']=$this->pdModel->getDataProductByPage($panigate['keyword'],$panigate['start'],$panigate['limit']);
...
// 		$data['phone']=$this->pdModel->getAllDataPhone('phone');
...
//   }
  public function delete()
  {
     $id = $_GET['id'] ?? '';
     $data ='';
     $data=$this->pdModel->xoasanpham('phone',$id);
